...
app.post('/api/create-reviews', (req, res) => {
    const fileContent = `
export const Reviews = () => {
    ...
    const folderPath = path.join(process.cwd(), 'src/components/4-library/reviews');
    const targetPath = path.join(folderPath, 'reviews-test.tsx');
